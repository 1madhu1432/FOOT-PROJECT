...
const commentsData = [
  {
    id: 1,
    commentor: "Nani Chinchula",
    image: "./comments-icon.png",
    reviewStar: 4.5,
  ...
  },
  {
    ...
    reviewDescription:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae justo at ligula tincidunt maximus.",
  },
  {
    id: 3,
    commentor: "Alice Smith",
    image: "./comments-icon.png",
    reviewStar: 5.0,
    reviewDate: "3 days ago",
    reviewDescription: "Great experience! The staff was friendly and the room was clean and comfortable.",
  },
  {
    id: 4,
    commentor: "Bob Johnson",
    image: "./comments-icon.png",
    reviewStar: 4.0,
    reviewDate: "4 weeks ago",
    reviewDescription:
      "The hotel location is perfect for exploring the city. However, the room service could be improved.",
  },
  {
    id: 5,
    commentor: "Emma Watson",
    image: "./comments-icon.png",
    reviewStar: 4.8,
    reviewDate: "2 months ago",
    reviewDescription:
      "I had a wonderful stay at this hotel. The facilities were excellent and the staff was very helpful.",
  },
...
let breakfastMixesData = [
  {
    ...
    DefaultImage: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712847296/2%2A2%20why%20nutrin%20food.png",
    category: "Mix Powders",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712847296/2%2A2%20why%20nutrin%20food.png",
      image2:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712859767/masala-dosa-served-with-sambhar-coconut-chutney-isolated-white-background-top_247037-450-removebg-preview_1_2_qzqncg.png",
      description:
  ...
  },
  {
    ...
    productDetails: {
      image1:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712859772/Stand-Up_Pouch_Bag_Mockup_2_3_2_x9qotl.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712859759/image_94_2_zwlby3.png",
      description:
        "Provides a balanced combination of carbohydrates (Rice) and protein (Lentils) and helps in preparing a quick and healthy breakfast",
  ...
  },
  {
    ...
    productDetails: {
      image1:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712859749/Stand-Up_Pouch_Bag_Mockup_4_2_3_akwjtw.png",
      image2:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712859748/ragi-dosa-healthy-south-indian-600w-2094559492-transformed-removebg-preview_1_2_e3zkah.png",
      description:
  ...
  },
  {
    ...
    productDetails: {
      image1:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712859758/Stand-Up_Pouch_Bag_Mockup_3_2_2_m2nuoo.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712859753/image_96_2_iahdra.png",
      description:
        "Provides a balanced combination of carbohydrates (Rice) and protein (Lentils) helps in preparing a quick and healthy breakfast. High in Protein and Fibre. Naturally Gluten Free.",
      ingredients:
  ...
  },
  {
    ...
    category: "Mix Powders",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712864178/Stand-Up_Pouch_Bag_Mockup_26_1_mx4xhw.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712864174/image_97_8_tbbzfn.png",
      description:
  ...
  },
  {
    ...
    category: "Chutney",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862257/Stand-Up_Pouch_Bag_Mockup_8_1_dvgije.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862253/image_122_1_qpftue.png",
  ...
  },
  {
    ...
    category: "Chutney",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862247/Stand-Up_Pouch_Bag_Mockup_9_1_m7edzo.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862242/image_101_1_f6ydso.png",
  ...
  },
  {
    ...
    category: "Chutney",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862230/Stand-Up_Pouch_Bag_Mockup_11_1_zfxues.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862224/image_105_1_hrgbfs.png",
      description: "Aids in digestion. Rich in Antioxidants.",
      ingredients:
  ...
  },
  {
    ...
    category: "Sambar",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862209/Stand-Up_Pouch_Bag_Mockup_13_1_gr4evm.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712862208/image_104_1_lgvxtp.png",
      description: "Aids in digestion. Rich in Antioxidants.",
      ingredients:
...
let nonVegmasalas = [
  {
    ...
    DefaultImage: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712847296/2%2A2%20why%20nutrin%20food.png",
    category: "Non-Veg Biryani Masala''s",
    image: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712842020/Frame_260_14_kcpooj.png",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712863317/Stand-Up_Pouch_Bag_Mockup_15_1_ofzemh.png",
      image2:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712863314/top-close-up-view-spices-appetizing-pilaf-cutting-board-colorful-spices-board-removebg-preview_1_2_qacyjm.png",
      description: "Aids in digestion. Rich in Antioxidants.",
      ingredients:
  ...
  },
  {
    ...
    category: "Non-Veg Biryani Masala''s",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712863282/Stand-Up_Pouch_Bag_Mockup_20_1_fyukuu.png",
      image2: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712863278/image_106_2_xdcwm4.png",
      description: "Aids in digestion. Rich in Antioxidants.",
      ingredients:
...
let vegMasalas = [
  {
    ...
    category: "Non-Veg Biryani Masala''s",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712863275/Stand-Up_Pouch_Bag_Mockup_21_1_sgwddx.png",
      image2:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712863274/homemade-chili-with-dips-peppers_1_1_ku3qdd.png",
      description: "Aids in digestion. Rich in Antioxidants.",
      ingredients:
  ...
  },
  {
    ...
    DefaultImage: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712847296/2%2A2%20why%20nutrin%20food.png",
    category: "Veg Masala's",
    productDetails: {
      image1:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712864200/Stand-Up_Pouch_Bag_Mockup_29_1_1_ytlgv6.png",
      image2:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712864197/mutton-lamb-biriyani-with-basmati-rice-served-bowl-moody-background_466689-27238__1_-transformed-removebg-preview_1_3_kyrtk7.png",
      description: "Aids in digestion. Rich in Antioxidants.",
      ingredients:
  ...
  },
  {
    ...
    category: "Veg Masala's",
    productDetails: {
      image1: "https://res.cloudinary.com/dqngbsszn/image/upload/v1712864185/Stand-Up_Pouch_Bag_Mockup_25_1_witqv7.png",
      image2:
        "https://res.cloudinary.com/dqngbsszn/image/upload/v1712864183/chicken-grill-with-vegetables-table-removebg-preview_1_3_agbzqa.png",
      description: "Aids in digestion. Rich in Antioxidants.",
...
function ProductInfo() {
  ...
  let products = [
    { id: uuidv4(), name: "Dosa powder", image: "./Frame 260 (2).png", price: 5.99 },
    { id: uuidv4(), name: "Idli powder", image: "./Frame 260 (2).png", price: 4.99 },
    { id: uuidv4(), name: "Wada powder", image: "./Frame 260 (2).png", price: 6.49 },
    { id: uuidv4(), name: "Ragi powder", image: "./Frame 260 (2).png", price: 6.49 },
  ];
  const [currentProductData, setCurrentProductData] = useState({});

  useEffect(() => {
    const presentProductId = query.get("id");
    axios
      .get("http://localhost:8080/getproduct?id=" + presentProductId)
      .then((response) => {
        console.log(response);
        let data = response.data.data;
        Object.keys(data.nutrients).forEach((val, key) => console.log({ val, key }));
  ...
  const presentProductCategory = query.get("category");
  const DefaultImage = "https://res.cloudinary.com/dqngbsszn/image/upload/v1712847296/2%2A2%20why%20nutrin%20food.png";
  const DefaultFoodImage =
    "https://res.cloudinary.com/dqngbsszn/image/upload/v1712847296/2%2A2%20why%20nutrin%20food.png";


    const handleOrderPage=(url)=>{
      localStorage.setItem('orderImage',url)
    }
  return (
    <div>
      <div className="">
        <div className="macbook-air-7">
          ...
          <div className="access-context-manager-svgrepo-parent">
            <img className="access-context-manager-svgrepo-icon" alt="" src="/accesscontextmanager-svgrepocom.svg" />
            <img className="vector-icon" alt="" src="/vector.svg" />
            <div className="nutryfood1">NUTRYFOOD</div>
            <b className="crowned-with-innovations2">CROWNED WITH INNOVATIONS</b>
          </div>
          <div className="component-58-parent" style={{ marginLeft: "300px" }}>
        ...
        <div className="filter-productdes">
          ...
          <div className="filter-productdes-1">{presentProductCategory}</div>
          <div className="filter-productdes-arrow">{`>`}</div>
        ...
        <div className="product-des-detail">
          <div className="product-side-images">
            <div>
              <img src={currentProductData?.imageProduct} className="DefaultImage"></img>
            </div>
            <div>
              <img src={currentProductData?.imageFood} className="product-des-side-image"></img>
            </div>
            <div>
              <img className="product-des-side-image" src={DefaultFoodImage}></img>
            </div>
            {/* <div>
              <img className="product-des-side-image" src={currentProductData?.imageFood2}></img>
            </div> */}
          </div>
          <div>
            <img className="product-des-main-image" src={currentProductData?.imageProduct}></img>
          </div>
          <div className="main-product-des">
            <div className="main-product-title">
              <div className="product-des-name">{currentProductData?.productName}</div>
            </div>
            <Link to="/orderpage">
              <button className="btn-review" onClick={()=>handleOrderPage(currentProductData?.imageProduct)}>Buy Now</button>
            </Link>
            <div className="dom-review">
              <span style={{ color: " #004AAD" }}>●</span> Domestic & International Markets- Accessible worldwide and
              everywhere
            </div>
              ...
              <div className="icon-why">
                <div className="why-nutry-icon">
                  <div className="nutry-icon">
                    <img src="./why-icon-1.png"></img>
                  </div>
                  <div className="icon-des">Best Quality</div>
                </div>
                <div className="why-nutry-icon">
                  <div className="nutry-icon">
                    <img src="./why-icon-1.png"></img>
        ...
        <div className="prod-details">
          <div className="Description">
            <div className="det-title">Description</div>
              ...
              {currentProductData.description &&
                currentProductData.description
                  ...
                  .map((point, index, array) => (
                    <li key={index} style={{ fontSize: "20px", marginLeft: "-4px", color: "rgba(0, 0, 0, 0.60)" }}>
                      {index === array.length - 1 ? point.trim() : point.trim() + "."}
                    </li>
                  ))}
            </ul>
          </div>
          <div className="Description">
            <div className="det-title">INGREDIENTS</div>
            <div style={{ fontSize: "18px", marginLeft: "14px", marginTop: "10px", color: "rgba(0, 0, 0, 0.60)" }}>
              ● {currentProductData.ingredients}
            </div>
          </div>
          <div className="Description">
            <div className="det-title">METHODS OF PREPARATION</div>
            <ul>
              {currentProductData.preparationMethod &&
                currentProductData.preparationMethod
                  .split(".")
                  .filter((point) => point.trim() !== "")
                  .map((point, index, array) => (
          ...
          {currentProductData.cookingTip && (
            <div className="Description">
              <div className="det-title">COOKING TIP</div>
              <ul>
                {currentProductData.cookingTip &&
                  currentProductData.cookingTip
                    .split(".")
          ...
          <div className="Description">
            <div className="det-title">NUTRITION INFORMATION</div>
            <div className="det-table">
              <table>
                ...
                <tbody>
                  {currentProductData.nutrients &&
                    Object.keys(currentProductData.nutrients).map((nutrient, index) => (
                      <tr key={index}>
                        <td>{toCapitalizedWords(nutrient)}</td>
                        <td>{units[nutrient]}</td>
                        <td>{currentProductData.nutrients[nutrient]}</td>
                      </tr>
                    ))}
                </tbody>
              </table>
        ...
        {/* ---------------more products-------------------- */}
        <div className="more-products-option" style={{ marginTop: "20px" }}>
          <h1 className="">People also order these</h1>

          <div className="prod-display">
            {products.map((product) => (
              <div key={product.id} className="prod-display-1" style={{ position: "relative", margin: "15px" }}>
                <div className="prod-card">
                  <div className="discount-tag">10% Off</div>
                  <div className="prod-card-image">
                    <img src="./Frame 260 (2).png" alt={product.name}></img>
                  </div>
      ...
      <div className="home">
        <div className="macbook-air-5">
          ...
          <div className="component-38-parent">
            ...
            <ExternalLink href="https://www.instagram.com/nutryfood_/">
              <img className="component-38-icon" alt="" src="/component-40.svg" />
            </ExternalLink>
            <ExternalLink href="https://www.facebook.com/NutryFoodIndustries/">
              {" "}
